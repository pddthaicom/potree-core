...
export class NodeLoader2
{
	...
	constructor(public hierarchyUrl: string, public logUrl: string, public metadataUrl: string, public octreeUrl: string, public workerPool: WorkerPool, public metadata: Metadata)
	{
	}
...
export class OctreeLoader
{
	...
	async loads(hierarchyUrl: string, logUrl: string, metadataUrl: string, octreeUrl: string, xhrRequest: XhrRequest)
	{ // Previously a static method
		...
		let loader = new NodeLoader2(hierarchyUrl, logUrl, metadataUrl, octreeUrl, this.workerPool, metadata);
		loader.attributes = attributes;
		loader.scale = metadata.scale;
		loader.offset = metadata.offset;
